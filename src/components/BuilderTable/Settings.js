...
const Settings = ({ format, onChangeSetting, htmlIndentWidth, rowClassPrefix, textIndentNumSpaces,
                ...
                <div key="indentWidth">
                    ...
                    <div>
                        <input type="number" value={htmlIndentWidth} style={{width: 40}}
                               onChange={(e) => onChangeSetting('htmlIndentWidth', e.target.value, 10)}/>px
                ...
                <div key="rowClassPrefix">
                    ...
                    <div>
                        <input type="text" value={rowClassPrefix}
                               onChange={(e) => onChangeSetting('rowClassPrefix', e.target.value)}/>
                ...
                <div key="numCharIndent">
                    ...
                    <div>
                        <input type="number" value={textIndentNumSpaces} style={{ width: 40 }}
                               onChange={(e) => onChangeSetting('textIndentNumSpaces', e.target.value, 10)} />
        ...
        if (format === "rtf") {
            rows.push(
                <div key="rtfDefaultFontSize">
                    ...
                    <div>
                        <input type="number" value={rtfDefaultFontSize} style={{ width: 40 }}
                               onChange={(e) => onChangeSetting('rtfDefaultFontSize', e.target.value)} /> pt
                    </div>
                </div>
            );
            rows.push(
                <div key="rtfDefaultLineHeight">
                    ...
                    <div>
                        <input type="number" value={rtfDefaultLineHeight} style={{ width: 40 }}
                               onChange={(e) => onChangeSetting('rtfDefaultLineHeight', e.target.value)} />
                    </div>
                </div>
            );
        }
